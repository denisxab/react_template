class Main {
	constructor(isDev, PathStatic, PathSrc, PublicPath) {
		this.isDev = isDev;
	...
	Entry() {
		return {
			...
			main: path.resolve(__dirname, `${this.PathSrc}/index.tsx`),
	...
	Output() {
		return {
			...
			path: path.resolve(__dirname, `${this.PathStatic}/`), // 127.0.0.1/static/frontend_react/public/ откуда подаются файлы
	...
	DevServer() {
		return {
			...
			static: {
				directory: path.join(__dirname, `${this.PathStatic}/`),
			},
...
obj_ = new Main(
	isDev,
	'frontend_react/static/frontend_react/public',
	'frontend_react/src',
	'/static/frontend_react/public/',
);
